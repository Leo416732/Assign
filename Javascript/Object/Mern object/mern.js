const users = [
    ...
    function getMoreSkills(skill){
        ...
        console.log(" Hamgiin ih skill ezemshsen hvn:",name,"\n","skills number:",moreSkill);
    }
    getMoreSkills(users);
    ...
    function getMern (mern){
        for(i = 0; i < mern.length; i++){
            for(j = 0; j < mern[i].skills.length; j++){
                if(
                mern[i].skills[j] === "MongoDB" == true && 
                mern[i].skills[j] === "Express" == true && 
                mern[i].skills[j] === "React" == true &&
                mern[i].skills[j] === "Node" == true
